...
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { m_axis_tdata }]; #IO_L16P_T2_35 Sch=led4_g
...
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { s_axis_ready }]; #IO_L22P_T3_AD7P_35 Sch=led5_g
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { m_axis_tdata }]; #IO_L23N_T3_35 Sch=led5_r
...
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { s_axis_tdata[0] }]; #IO_L4P_T0_35 Sch=btn[0]
set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { s_axis_tdata[1] }]; #IO_L4N_T0_35 Sch=btn[1]
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS33 } [get_ports { s_axis_tdata[2] }]; #IO_L9N_T1_DQS_AD3N_35 Sch=btn[2]
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { s_axis_tdata[3] }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]
